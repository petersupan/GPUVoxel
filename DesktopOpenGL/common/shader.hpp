...
struct LandscapeGenerationShaderEffect : public SimpleShaderEffect
{
	LandscapeGenerationShaderEffect(unsigned int programId);
	unsigned int imageId;
};

struct LandscapeImShaderEffect : public SimpleShaderEffect
{
	LandscapeImShaderEffect(unsigned int programId);
	unsigned int heightSamplerId;
